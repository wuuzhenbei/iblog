...
public class AiCopywritingServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        String style = params.getOrDefault("style", "治愈");
        String topic = params.get("topic");
        if (topic == null || topic.trim().isEmpty()) {
            JsonUtil.sendError(resp, 400, "请输入主题");
            return;
        }

        String result = AiUtil.generateCopywriting(style, topic);
